...
{
    public class ViewModel_System_CalibrationInlet : Model_System_Calibration
    {
        #region 생성자 & 이벤트 헨들러
        ...
        private void SetCommandAction(object param)
        {
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.TEMP_CALIBRATION_T1:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_SET_TEMP_CALIBRATION_T1;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_SET_TEMP_CALIBRATION_T1;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_SET_TEMP_CALIBRATION_T1;
                                }
                                break;
                        }
                    }
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.TEMP_CALIBRATION_T2:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_SET_TEMP_CALIBRATION_T2;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_SET_TEMP_CALIBRATION_T2;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_SET_TEMP_CALIBRATION_T2;
                                }
                                break;
                        }
                    }
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.FLOW_CALIBRATION1:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_SET_FLOW_CALIBRATION1;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_SET_FLOW_CALIBRATION1;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_SET_FLOW_CALIBRATION1;
                                }
                                break;
                        }
                    }
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.FLOW_CALIBRATION2:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_SET_FLOW_CALIBRATION2;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_SET_FLOW_CALIBRATION2;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_SET_FLOW_CALIBRATION2;
                                }
                                break;
                        }
                    }
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.FLOW_CALIBRATION3:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_SET_FLOW_CALIBRATION3;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_SET_FLOW_CALIBRATION3;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_SET_FLOW_CALIBRATION3;
                                }
                                break;
                        }
                    }
            ...
            EventManager.KeyPadRequestEvent(vmKeyPad);
            //TODO :             
            Debug.WriteLine(string.Format("{0} Inlet : {1} SetCommand Fired", _e_INLET_TYPE, (E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE)param));
        }
        ...
        private void MeasuredCommandAction(object param)
        {
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.TEMP_CALIBRATION_T1:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_MEASURE_TEMP_CALIBRATION_T1;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_MEASURE_TEMP_CALIBRATION_T1;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_MEASURE_TEMP_CALIBRATION_T1;
                                }
                                break;
                        }
                    }
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.TEMP_CALIBRATION_T2:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_MEASURE_TEMP_CALIBRATION_T2;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_MEASURE_TEMP_CALIBRATION_T2;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_MEASURE_TEMP_CALIBRATION_T2;
                                }
                                break;
                        }
                    }
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.FLOW_CALIBRATION1:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_MEASURE_FLOW_CALIBRATION1;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_MEASURE_FLOW_CALIBRATION1;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_MEASURE_FLOW_CALIBRATION1;
                                }
                                break;
                        }
                    }
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.FLOW_CALIBRATION2:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_MEASURE_FLOW_CALIBRATION2;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_MEASURE_FLOW_CALIBRATION2;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_MEASURE_FLOW_CALIBRATION2;
                                }
                                break;
                        }
                    }
                ...
                case E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE.FLOW_CALIBRATION3:
                    {
                        ...
                        switch (_e_INLET_LOCATION)
                        {
                            case E_INLET_LOCATION.FRONT:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_FRONT_MEASURE_FLOW_CALIBRATION3;
                                }
                                break;
                            case E_INLET_LOCATION.CENTER:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_CENTER_MEASURE_FLOW_CALIBRATION3;
                                }
                                break;
                            case E_INLET_LOCATION.REAR:
                                {
                                    vmKeyPad.KEY_PAD_SET_MEASURE_TYPE = E_KEY_PAD_SET_MEASURE_TYPE.INLET_REAR_MEASURE_FLOW_CALIBRATION3;
                                }
                                break;
                        }
                    }
            ...
            //TODO :             
            Debug.WriteLine(string.Format("{0} Inlet : {1} MeasuredCommand Fired", _e_INLET_TYPE, (E_SYSTEM_CALIBRATION_INLET_SET_MEASURE_COMMAND_TYPE)param));
        }
        ...
        private void ResetCommandAction(object param)
        {
            switch(_e_INLET_LOCATION)
            {
                case E_INLET_LOCATION.FRONT:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_TEMP_RESET, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.CENTER:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_TEMP_RESET, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.REAR:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_TEMP_RESET, tcpManager);
                    }
                    break;
            }          
        }
        ...
        private void ApplyCommandAction(object param)
        {
            switch (_e_INLET_LOCATION)
            {
                case E_INLET_LOCATION.FRONT:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_TEMP_APPLY, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.CENTER:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_TEMP_APPLY, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.REAR:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_TEMP_APPLY, tcpManager);
                    }
                    break;
            }
        }
        ...
        private void SensorZeroResetCommandAction(object param)
        {
            switch (_e_INLET_LOCATION)
            {
                case E_INLET_LOCATION.FRONT:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_SENSORZERO_RESET, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.CENTER:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_SENSORZERO_RESET, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.REAR:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_SENSORZERO_RESET, tcpManager);
                    }
                    break;
            }
        }
        ...
        private void SensorZeroStartCommandAction(object param)
        {
            ...
            if (bIsDoingSensorZeroCalibration)
            {
                switch (_e_INLET_LOCATION)
                {
                    case E_INLET_LOCATION.FRONT:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_SENSORZERO_START, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.CENTER:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_SENSORZERO_START, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.REAR:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_SENSORZERO_START, tcpManager);
                        }
                        break;
                }
            }
            ...
            else
            {
                switch (_e_INLET_LOCATION)
                {
                    case E_INLET_LOCATION.FRONT:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_SENSORZERO_STOP, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.CENTER:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_SENSORZERO_STOP, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.REAR:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_SENSORZERO_STOP, tcpManager);
                        }
                        break;
                }
            }
        ...
        private void SensorZeroApplyCommandAction(object param)
        {
            switch (_e_INLET_LOCATION)
            {
                case E_INLET_LOCATION.FRONT:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_SENSORZERO_APPLY, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.CENTER:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_SENSORZERO_APPLY, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.REAR:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_SENSORZERO_APPLY, tcpManager);
                    }
                    break;
            }
        }
        ...
        private void ValveResetCommandAction(object param)
        {
            switch (_e_INLET_LOCATION)
            {
                case E_INLET_LOCATION.FRONT:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_VALVE_RESET, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.CENTER:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_VALVE_RESET, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.REAR:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_VALVE_RESET, tcpManager);
                    }
                    break;
            }
        }
        ...
        private void ValveStartCommandAction(object param)
        {
            ...
            if (bIsDoingValveCalibration)
            {
                switch (_e_INLET_LOCATION)
                {
                    case E_INLET_LOCATION.FRONT:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_VALVE_START, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.CENTER:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_VALVE_START, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.REAR:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_VALVE_START, tcpManager);
                        }
                        break;
                }
            }
            ...
            else
            {
                switch (_e_INLET_LOCATION)
                {
                    case E_INLET_LOCATION.FRONT:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_VALVE_STOP, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.CENTER:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_VALVE_STOP, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.REAR:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_VALVE_STOP, tcpManager);
                        }
                        break;
                }
            }
        ...
        private void ValveApplyCommandAction(object param)
        {
            switch (_e_INLET_LOCATION)
            {
                case E_INLET_LOCATION.FRONT:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_VALVE_APPLY, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.CENTER:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_VALVE_APPLY, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.REAR:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_VALVE_APPLY, tcpManager);
                    }
                    break;
            }
        }
        ...
        private void FlowResetCommandAction(object param)
        {
            switch (_e_INLET_LOCATION)
            {
                case E_INLET_LOCATION.FRONT:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_FLOW_RESET, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.CENTER:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_FLOW_RESET, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.REAR:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_FLOW_RESET, tcpManager);
                    }
                    break;
            }
        }
        ...
        private void FlowStartCommandAction(object param)
        {
            ...
            if (bIsDoingFlowCalibration)
            {
                switch (_e_INLET_LOCATION)
                {
                    case E_INLET_LOCATION.FRONT:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_FLOW_START, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.CENTER:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_FLOW_START, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.REAR:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_FLOW_START, tcpManager);
                        }
                        break;
                }
            }
            ...
            else
            {
                switch (_e_INLET_LOCATION)
                {
                    case E_INLET_LOCATION.FRONT:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_FLOW_STOP, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.CENTER:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_FLOW_STOP, tcpManager);
                        }
                        break;
                    case E_INLET_LOCATION.REAR:
                        {
                            this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_FLOW_STOP, tcpManager);
                        }
                        break;
                }
            }
        ...
        private void FlowApplyCommandAction(object param)
        {
            switch (_e_INLET_LOCATION)
            {
                case E_INLET_LOCATION.FRONT:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_FRONT_FLOW_APPLY, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.CENTER:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_CENTER_FLOW_APPLY, tcpManager);
                    }
                    break;
                case E_INLET_LOCATION.REAR:
                    {
                        this.SendCommand(E_GLOBAL_COMMAND_TYPE.E_INLET_REAR_FLOW_APPLY, tcpManager);
                    }
                    break;
            }
        }
