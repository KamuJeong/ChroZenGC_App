...
namespace ChroZenService
{
    ...
    public class ValueEditor : Grid
    {
        ...
        public static readonly BindableProperty CommandProperty = BindableProperty.Create("Command", typeof(ICommand), typeof(ValueEditor), null);
        ...
        public static readonly BindableProperty CommandParameterProperty = BindableProperty.Create("CommandParameter", typeof(object), typeof(ValueEditor), null);
        ...
        public static readonly BindableProperty TextProperty = BindableProperty.Create("Text", typeof(string), typeof(ValueEditor), null, propertyChanged: SwitchValueChanged);
        public string Text
        {
