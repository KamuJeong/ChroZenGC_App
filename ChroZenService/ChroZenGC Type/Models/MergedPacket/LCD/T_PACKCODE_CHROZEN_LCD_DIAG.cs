...
{
    public struct T_PACKCODE_CHROZEN_LCD_DIAG : I_CHROZEN_GC_PACKET
    {
        public T_HEADER_PACKET header;
        public T_SYSTEM_LCD_Diag packet;
    }
    public static class T_PACKCODE_CHROZEN_LCD_DIAGManager
    {
        static T_PACKCODE_CHROZEN_LCD_DIAGManager()
        {
            InitiatedInstance = GetInitializedInstance();
        }
        public static T_PACKCODE_CHROZEN_LCD_DIAG InitiatedInstance;

        static T_PACKCODE_CHROZEN_LCD_DIAG GetInitializedInstance()
        {
            return new T_PACKCODE_CHROZEN_LCD_DIAG
            {
                header = T_HEADER_PACKETManager.InitiatedInstance,
                packet = T_SYSTEM_LCD_DiagManager.InitiatedInstance
            };
        }
